...
const menu = [
  ...
  // Compliance tab will be inserted here
  ...
  { to: '/risk-assessment', label: 'Risk Assessment', icon: <svg className="nav-icon" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg> },
  ...
  { to: '/users', label: 'Users', icon: <svg className="nav-icon" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" /></svg> },
];
    ...
    <aside className={`sidebar${collapsed ? ' collapsed' : ''}`}>
      ...
      <nav>
        <ul className="nav-menu">
          ...
          {/* Compliance tab with submenu */}
          <li
            className="nav-item compliance-parent"
          ...
          >
            ...
            {showComplianceSub && !collapsed && (
              <ul className="sidebar-submenu">
                <li>
                  <NavLink to="/compliance/iso" className="sidebar-sublink">ISO</NavLink>
                </li>
                <li>
                  <NavLink to="/compliance/cibil" className="sidebar-sublink">CIBIL</NavLink>
                </li>
                <li>
                  <NavLink to="/compliance/cicra" className="sidebar-sublink">CICRA</NavLink>
                </li>
                <li>
